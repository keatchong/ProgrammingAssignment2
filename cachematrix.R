...
## 2) compute inverse of the matrix and save it to cache or retrieve the inverse 
## solely from cache if it's available


## this function set the value of the matrix, get the value of thr matrix,
